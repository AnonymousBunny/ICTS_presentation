...
\begin{figure}[htbp]
	...
	\includegraphics[width=0.4\textwidth]{quantum_communication.png} 
	
	\caption{ChatGPT's impression of Alice and Bob doing quantum communication}
...
\begin{frame}{Prior work}
	\begin{itemize}
		...
		\item<5-> \textbf{Lovett, Knop, McGuire, Yuan (2021)} proved the log rank conjecture for AND functions. By an intermediate result in their proof, it became  clear that proving the relation conjectured by Buhrman and de Wolf would also imply the Quantum Equivalence Conjecture for $\text{AND}$ functions.
	\end{itemize}
...
\begin{frame}{Prior work}
	\begin{itemize}
		...
		\item<2-> They also showed the Quantum Equivalence Conjecture for functions of the form $g \circ \text{EQ}_4$.
